            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg p-6">
                <form method="POST" action="{{ route('pages copy.dashboard.berita.update', $berita->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="content" id="summernote" class="content mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('content', $berita->content) }}</textarea>
                    </div> 
