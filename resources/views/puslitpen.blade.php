...
<html lang="en">
    <head>
        ...
        <title>{{__('message.pusathome.puslitpenlang.tittle')}}</title>
            ...
            <div class="pusatpsheader">
                ...
                <div class="header-text">
                    <div class="titlepusatps">
                        <h5>{{__('message.pusathome.puslitpenlang.tittle')}}</h5>
                        <h6>{{__('message.pusathome.puslitpenlang.kepanjangan')}}</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content-boxpusatps">
            ...
            <div class="content-bodypusatps">
                ...
                <div class="descriptionpusatps">
                  {{__('message.descriptionpuslitpen')}}
                </div>
            </div>
        </div>
    </div>
