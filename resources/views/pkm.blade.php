...
<html lang="en">
    <head>
        ...
        <title>{{__('message.pusathome.pkmlang.tittle')}}</title>
            ...
            <div class="pusatpsheader">
                ...
                <div class="header-text">
                    <div class="titlepusatps">
                        <h5>{{__('message.pusathome.pkmlang.tittle')}}</h5>
                        <h6>{{__('message.pusathome.pkmlang.kepanjangan')}}</h6>
                    </div>
                </div>
            </div>
        </div>
